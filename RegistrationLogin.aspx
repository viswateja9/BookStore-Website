<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrationLogin.aspx.cs" Inherits="RegistrationLogin" %>
...
<body>
    ...
    <img class="image" style="margin-left:-7px;margin-right:0px" src="Images/mybanner.jpg"/> 
        ...
        <div style="width:100%">
              <div style="width:30%;background-color:#1e0e0e;float:right; margin-left: 6px;">
            <p style="font-size:25px;color:#978b8b;">Already have an Account?</p>
                  <p style="font-size:18px;color:#978b8b;">Login</p>
                 <label style="color:#978b8b;width:110px;display:inline-block;">Email Address</label>
             <asp:TextBox ID="TextBox8"  Width="50%" runat="server" />
            <br /><br />
            <label style="color:#978b8b;width:110px;display:inline-block;">Password</label>
             <asp:TextBox ID="TextBox9" TextMode="Password" Width="50%" runat="server" />
            <br /><br />
                  <asp:Button ID="b3" ValidationGroup="Group2" onClick="b3_Click" Text="Login" runat="server" />
            <asp:Button ID="b4" Text="Forgot Password" OnClick="b4_Click" runat="server" />
           </div >
        <div style="margin-left:-7px;margin-top:-25px;width:70%;background-color:#1e0e0e;">
            <p style="font-size:25px;color:#978b8b;">Personal information</p>
             <p style="font-size:18px;color:#978b8b;">Tell us a little about yourself. This information is <b>only</b> used so we can <b>pay</b> you,provide a <b>free shipping label</b>, and <b>communicate with you.</b></p>
            ...
            <asp:RequiredFieldValidator ID="namevd" ValidationGroup="Group1" ForeColor="Red" Font-Size="Small"  ErrorMessage="Name is required" runat="server" ControlToValidate="tb1"></asp:RequiredFieldValidator>
            <br /><br />
          ...
          <asp:RegularExpressionValidator ID="emailrvd" ForeColor="Red" Font-Size="Small"  ErrorMessage="Email should be in correct format" 
                runat="server" ControlToValidate="TextBox5" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$"></asp:RegularExpressionValidator>
           
            <br /><br /> 
            <label class="required" style="color:#978b8b;width:130px;display:inline-block;">Password</label>
             <asp:TextBox ID="TextBox6" ValidationGroup="Group1" TextMode="Password"  Width="25%" runat="server" />
          ...
          <asp:RegularExpressionValidator ID="passrvd" ForeColor="Red" Font-Size="Small"  ErrorMessage="Password should be in correct format" 
            ...
            <label style="color:#978b8b;width:130px;display:inline-block;">Confirm Password</label>
             <asp:TextBox ID="TextBox7" ValidationGroup="Group1" TextMode="Password"  Width="25%" runat="server" />
            ...
            <asp:Button ID="b2" ValidationGroup="Group1" onclick="b2_Click" Text="Complete Registration" runat="server" />
         </div>
            </div>
    </form>
</body>
